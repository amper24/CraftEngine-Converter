...
class SchemaRegistry:
    ...
    def condition_types(self) -> set[str]:
        return set(self.data.get("conditions", {}).get("known_condition_types", []))

    @property
    def loot_entry_types(self) -> set[str]:
        return set(self.data.get("loot", {}).get("known_loot_entry_types", []))

    @property
    def loot_function_types(self) -> set[str]:
        return set(self.data.get("loot", {}).get("known_loot_function_types", []))
